                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 overflow-y-auto pb-4 pr-1">
                    {gameState.adventurers.map(adv => {
                        ...
                        return (
                            ...
                            >
                                {adv.status !== 'idle' && <div className="absolute -top-2 -right-2 bg-indigo-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded shadow-sm">派遣中</div>}
                                <div>
